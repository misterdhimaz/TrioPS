@props(['products', 'bookedSlots' => []])

<!-- CATALOG SECTION -->
<section id="catalog" class="py-[100px] bg-[#03050a] px-6 border-t border-white/5 relative">
    ...
    <div class="max-w-[1300px] mx-auto relative z-10">
        ...
        <div class="flex flex-col items-center text-center mb-[60px]">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#00e5ff]/30 bg-[#00e5ff]/5 mb-[20px] shadow-[0_0_15px_rgba(0,229,255,0.1)]">
                ...
                <span class="text-[#00e5ff] text-[10px] font-bold tracking-[2px] uppercase">Katalog Konsol</span>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[25px]">
            ...
            <!-- KOMPONEN MODAL DINAMIS (Hanya dipanggil di dalam loop agar id-nya unik) -->
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-3 py-20 text-center bg-[#0B1221]/50 border border-[#1A233A] border-dashed rounded-[24px]">
                ...
                <p class="text-[#8A99B5] text-[12px] font-bold uppercase tracking-[2px]">Admin belum menambahkan armada tempur ke dalam database.</p>
            </div>
            @endforelse
        </div>
    </div>
...
<script>
    ...
    function renderTimeSlots(productId, selectedDate) {
        ...
        if(!container) return; // Prevent error if modal not loaded properly
