    ...
    <div class="bg-[#0B1221] w-full max-w-[420px] p-[35px_30px] rounded-[12px] border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative box-border
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-[18px]">
                ...
                <input id="password" type="password" name="password" class="w-full p-[12px_15px] bg-[#03060D] border border-[#1A233A] rounded-[6px] text-white font-['Inter',_sans-serif] text-[13px] box-border transition-all duration-300 focus:outline-none focus:border-[#00A3FF] focus:ring-0 focus:shadow-[0_0_12px_rgba(0,163,255,0.2)]" required placeholder="Enter Password">
            </div>
