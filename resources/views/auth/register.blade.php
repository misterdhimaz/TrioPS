...
<body class="m-0 p-4 w-full min-h-screen bg-[#050914] font-['Inter',_sans-serif] flex flex-col justify-center items-center text-white selection:bg-[#00A3FF] selection:text-black">
    ...
    <div class="bg-[#0B1221] w-full max-w-[420px] p-[35px_30px] rounded-[12px] border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative box-border
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-[18px]">
                ...
                <input id="password" type="password" name="password" class="w-full p-[12px_15px] bg-[#03060D] border border-[#1A233A] rounded-[6px] text-white font-['Inter',_sans-serif] text-[13px] box-border transition-all duration-300 focus:outline-none focus:border-[#00A3FF] focus:ring-0 focus:shadow-[0_0_12px_rgba(0,163,255,0.2)]" required placeholder="Masukkan password">
            </div>

            <div class="mb-[18px]">
                <label for="password_confirmation" class="block text-[11px] text-[#8A99B5] mb-[6px] tracking-[0.5px]">Konfirmasi Password</label>
                <input id="password_confirmation" type="password" name="password_confirmation" class="w-full p-[12px_15px] bg-[#03060D] border border-[#1A233A] rounded-[6px] text-white font-['Inter',_sans-serif] text-[13px] box-border transition-all duration-300 focus:outline-none focus:border-[#00A3FF] focus:ring-0 focus:shadow-[0_0_12px_rgba(0,163,255,0.2)]" required placeholder="Ulangi password">
            </div>

            <!-- Area Checkbox dan Tombol Popup T&C -->
    ...
    <!-- MODAL TERMS & CONDITION (Hidden by default) -->
    ...
    <script>
        ...
        function openModal() {
            ...
            // Sedikit delay untuk trigger animasi transisi
            setTimeout(() => {
        ...
        function agreeTerms() {
            // Otomatis centang checkbox saat klik 'Saya Setuju'
